...
public class GlobalExceptionHandler {
    ...
    public Mono<@NonNull ProblemDetail> handleBusiness(
    ...
    public Mono<@NonNull ProblemDetail> handleExternal(
            ExternalServiceException ex,
            ServerHttpRequest request
    ) {
        log.error("Error al invocar servicio externo", ex);
        ProblemDetail pd = buildProblemDetail(
                HttpStatus.BAD_GATEWAY,
                "ERROR_SERVICIO_EXTERNO",
                ex.getMessage(),
                "SERVICIO_EXTERNO_FALLA",
                request
        );
        return Mono.just(pd);
    }
    ...
    public Mono<@NonNull ProblemDetail> handleDataAccess(
        ...
        log.error("Error de acceso a datos en Order Service", ex);
    ...
    public Mono<@NonNull ProblemDetail> handleGeneric(
        ...
        log.error("Error inesperado en Order Service", ex);
